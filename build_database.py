...
db.session.commit()
# SQLAlchemy is aware of the relationship between Person and Note objects.
# When a Person object is committed to the person database table,
# SQLAlchemy gets the person_id primary key value.
# That value is used to initialize the foreign key value of person_id in a
# Note object before it’s committed to the database.
